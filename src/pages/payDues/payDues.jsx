        ...
        "outputs": [
            {
                ...
                "internalType": "struct Fees_General.Payer",
                "name": "",
                "type": "tuple"
            }
        ],
...
const tx =  contract.mint("Chimbo Udochukwu Enyinnaya", "Electronic Engineering", "400LVL");
await tx.wait(1);
    ...
    <main className='min-h-screen container body mx-auto lg:px-20 px-5'>
      ...
      <section className='lg:flex lg:mt-20 mt-10 lg:pb-20 pb-10 justify-between'>
        ...
        <div className='basis-1/2 flex flex-col justify-center lg:mt-0 mt-10'>
          ...
          <button  onClick={Mint} className='bg-gradient-to-r from-primary to-secondary mt-5 text-white font-semibold px-8 py-4 w-full rounded-xl'>
         MINT  
          </button>
        </div>
      </section>
