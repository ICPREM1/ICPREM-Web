...
const Features = () => {
  ...
  return (
    <main>
      <p
        className='text-center pt-20 body font-bold text-lg text-text
'
      >
        Features
      </p>
      ...
      <section className='flex lg:flex-row flex-col justify-between items-center lg:items-stretch my-10 lg:my-24'>
        {reasons.map((item, index) => (
          <div
            key={index}
            className='basis-[30%] rounded-2xl lg:my-0 my-5 flex flex-col lg:w-auto w-[80vw] box items-center'
          >
            <img
              src={pic}
              alt='card-icon'
              className='h-12 w-16 mt-5 lg:mt-16'
            />
            <p className='lg:text-2xl head text-lg font-semibold mt-5 lg:mt-10'>
              {item.heading}
            </p>
